...
class HouseDetailsForm(forms.ModelForm):
    class Meta:
        model = HouseDetail
        fields = ('owner_name', 'price_range','building_floors_square_feet','zone_category','distance_from_road','total_area_covered','room_type','population_in_area',
                  'house_rating','material_rating','room_type','neighbourhood_class','year_built','year_rebuilt','roof_material','basement_quality','heating','bathroom_type','kitchen_quality','house_image','room_image'
                  )